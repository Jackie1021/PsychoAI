...
class _FeatureSelectionPageState extends State<FeatureSelectionPage>
  ...
  void _startMatching() async {
    ...
    // Update traits and wait for completion
    await apiService.updateCurrentUserTraits(selectedTraits, freeText);
    
    print('✅ Traits updated, proceeding to AI thinking process...');

    if (mounted) {
      Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => MatchingThinkingPage(
